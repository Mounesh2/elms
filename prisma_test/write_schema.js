...
const content = `generator client {
  ...
  output   = "../../learnhub/lib/generated/prisma"
}
...
model Enrollment {
  ...
  courseId           String         @map("course_id")
  enrollmentType     EnrollmentType @default(paid) @map("enrollment_type")
